...
create table if not exists founders (
  ...
  city text,
  stats text,
  creator_type text default 'founder',
  public_name text,
  content_categories text,
  primary_platform text,
  audience_size bigint default 0,
  engagement_rate numeric(7, 3) default 0,
...
alter table athletes add column if not exists instagram_url text;
alter table athletes add column if not exists tiktok_url text;
alter table athletes add column if not exists facebook_url text;
alter table athletes add column if not exists linkedin_url text;
...
alter table founders add column if not exists instagram_url text;
